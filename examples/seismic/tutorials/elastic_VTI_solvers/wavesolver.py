...
class ElasticVTIWaveSolver(object):
    ...
    def forward(self, src=None, rec1=None, rec2=None, epsilon=None, delta=None, gamma=None, irho=None,
        ...
        # Pick Anisotropy parameters from model unless explicitly provided
        epsilon = epsilon or self.model.epsilon
        delta = delta or self.model.delta
        gamma = gamma or self.model.gamma
        irho = irho or self.model.irho
        # Execute operator and return wavefield and receiver data
        summary = self.op_fwd(save).apply(src=src, rec1=rec1, epsilon=epsilon, delta=delta, gamma=gamma, irho=irho,
